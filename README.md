...
Worldscape is a focused fork of [Tiled](https://github.com/mapeditor/tiled) for
low-fidelity world planning: terrain and topology, building areas, props, NPC
routes and routines, player traversal, and agent-readable layout proposals.

The project is currently bootstrapping from the upstream Tiled codebase. The
original Tiled documentation follows while the Worldscape-specific workflow and
